...
dotaWebAPI.prototype.getMatchDetails = function (matchId) {
	...
	return fetch(API_URL + "IDOTA2Match_" + this.appId + "/GetMatchDetails/v1" + query(parameters))
...
dotaWebAPI.prototype.getLeagueListing = function(lang) {
	...
	return fetch(API_URL + "IDOTA2Match_" + this.appId + "/GetLeagueListing/v1/" + query(parameters))
			.then(response => JSON.parse(response));
}
...
dotaWebAPI.prototype.getLiveLeagueGames = function() {
	...
	return fetch(API_URL + "IDOTA2Match_" + this.appId + "/GetLiveLeagueGames/v1/" + query(parameters))
			.then(response => JSON.parse(response));
}
...
dotaWebAPI.prototype.getMatchHistory = function(heroId, gameMode, skill, minPlayers, accountId, leagueId, startAtMatchId, matchesRequested, tournamentGamesOnly) {
	...
	return fetch(API_URL + "IDOTA2Match_" + this.appId + "/GetMatchHistory/v1/" + query(parameters))
			.then(response => JSON.parse(response))
}
...
dotaWebAPI.prototype.getMatchHistoryBySequenceNumber = function(startMatchSeqNum, matchesRequested) {
	...
	return fetch(API_URL + "IDOTA2Match_" + this.appId + "/GetMatchHistoryBySequenceNum/v1" + query(parameters))
			.then(response => JSON.parse(response))
}
...
// 		"date_max" : dateMax
// 	}
// 	return fetch(API_URL + "IDOTA2Match_" + this.appId + "/GetScheduledLeagueGames/v1/" + query(parameters))
// 			.then(response => JSON.parse(response))
// }
...
dotaWebAPI.prototype.getTeamInfo = function(startTeamId, teamsRequested) {
	...
	return fetch(API_URL + "IDOTA2Match_" + this.appId + "/GetTeamInfoByTeamID/v1" + query(parameters))
			.then(response => JSON.parse(response))
}
...
dotaWebAPI.prototype.getTournamentPlayerStats = function(accountId, leagueId, heroId, timeFrame) {
	...
	return fetch(API_URL + "IDOTA2Match_" + this.appId + "/GetTournamentPlayerStats/v1" + query(parameters))
			.then(response => JSON.parse(response))
}
...
dotaWebAPI.prototype.getItems = function(lang) {
	...
	return fetch(API_URL + "IEconDOTA2_" + this.appId + "/GetGameItems/v1" + query(parameters))
			.then(response => JSON.parse(response))
}
...
dotaWebAPI.prototype.getHeroes = function(lang, ifItemized) {
	...
	return fetch(API_URL + "IEconDOTA2_" + this.appId + "/GetHeroes/v1" + query(parameters))
			.then(response => JSON.parse(response))
}
